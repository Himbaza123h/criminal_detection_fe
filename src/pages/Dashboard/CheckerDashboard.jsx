...
import Sidebar from '../../components/Sidebar/Checker/index';
...
<div className="flex h-screen overflow-hidden">
    ...
    <div className="flex flex-col flex-1 overflow-y-auto">
        ...
        <main className="flex-grow p-4 md:p-6 lg:p-8">
            <h1 className="text-3xl font-bold mb-6">Checker Dashboard</h1>


            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6 h-86 mt-8">
